  ...
  return (
      <main>
            <div className={styles.pageContainer}>              
              ...
              <h1 style={{ fontSize: '30px', fontWeight: 'bolder', margin: '20px', fontFamily: 'golos text', fontWeight: '600' }}>Welcome to EduStack for RVITM</h1>
              ...
              <Link href='/accounts/signin' style={{width: '95%'}}><button className={styles.primaryButton}>Sign In </button></Link>
